...
import { PieChart, Pie, ResponsiveContainer, Label, LabelList, Legend, Cell } from 'recharts';
...
function AdminMainPageFeedback(props) {
  ...
  const feedbackCountQuery = useQuery(["feedbackCountQuery"], getFeedbackCountRequest, 
  {
    retry: 0,
